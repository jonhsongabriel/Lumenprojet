        ...
        <Navbar.Collapse id="navbar-nav">
          <Nav className="mx-auto d-flex align-items-center">
            ...
            >
              ...
              <NavDropdown.Item as={Link} to="/monitor/alert">Alertes</NavDropdown.Item>
            ...
            <NavDropdown
              ...
              drop="down-centered"
            >
              <NavDropdown.Item as={Link} to="/analyse/service">Demande de service</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/analyse/plan">Plan</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/analyse/journal">Journal de maintenance</NavDropdown.Item>
            </NavDropdown>
